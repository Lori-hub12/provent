...
app.get('/api/dashboard/proveedor/:id/materiales', async (req,res)=>res.json(await all('SELECT * FROM materiales WHERE proveedor_id=? AND estado=\'Activo\' ORDER BY created_at DESC',[req.params.id])));
